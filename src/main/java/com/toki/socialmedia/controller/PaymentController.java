...
import com.toki.socialmedia.config.VNPayConfig;
import com.toki.socialmedia.dto.respone.PaymentResDTO;
import com.toki.socialmedia.dto.respone.TransactionStatusDTO;
...
public class PaymentController {
    ...
    public ResponseEntity<?> test() throws UnsupportedEncodingException {
        ...
        String vnp_TmnCode = VNPayConfig.vnp_TmnCode_Static;
        ...
        vnp_Params.put("vnp_ReturnUrl", VNPayConfig.vnp_ReturnUrl_Static);
        ...
        String vnp_SecureHash = VNPayConfig.hmacSHA512(VNPayConfig.vnp_HashSecret_Static, hashData.toString());
    ...
    @Operation(summary = "Get transaction information after sucessful")
    @GetMapping("/info")
